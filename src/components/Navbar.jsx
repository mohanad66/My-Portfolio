    ...
    return (
        ...
        >
            ...
            <div className="hidden md:flex gap-10 text-xs font-bold tracking-[0.2em] uppercase text-gray-400">
                {['Home', 'About', 'Projects', 'Skills', 'Awards', 'Contact'].map((item) => (
            ...
            <div className="hidden md:flex items-center gap-4">
                <a href="https://github.com/mohanad66" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://www.linkedin.com/in/mohanad-mahmoud-6086b1254/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
